package com.zurc.digdocs.client.samples;
...
import com.zurc.digdocs.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.zurc.digdocs.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
